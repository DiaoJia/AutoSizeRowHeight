...
{
    public class GrowRowTableSource:UITableViewSource
    {
        public List<GrowItem> Items = new List<GrowItem>();

        public GrowRowTableSource()
        {
            Initialize();
        }
        ...
        {
            var cell = tableView.DequeueReusableCell(GrowRowTableViewCell.Key) as GrowRowTableViewCell;
		...
		{			
			Items.Add(new GrowItem("Macintosh_128k.png", "Macintosh 128K", "The Macintosh 128K, equivalent to $5,683 in 2015)."));
